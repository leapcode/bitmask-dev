...
latex_documents = [
    (master_doc, 'Bitmask.tex', u'Bitmask Documentation',
...
man_pages = [
    (master_doc, 'bitmask', u'Bitmask Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Bitmask', u'Bitmask Documentation',
     author, 'Bitmask', 'One line description of project.',
     'Miscellaneous'),
]
